 ...
 * which implement {@link #ua.nure.miroshnichenko.touragency.myorm.Entity}. Entities can be mapped into sql
 * queries and results of queries can be mapped into entities using
 * {@link #ua.nure.miroshnichenko.touragency.myorm.core.mapping.Mapper}.
 * 
 * @author Miroshnichenko Y. D
 * @see #ua.nure.miroshnichenko.touragency.myorm.core.mapping.Mapper
 */
