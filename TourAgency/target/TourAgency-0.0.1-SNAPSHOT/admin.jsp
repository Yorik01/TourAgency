          ...
          <div class="sidebar-sticky">
           <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/TourAgency/controller?action=tourForm">
                <i class="fa fa-plus"></i>
					Add tour
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/TourAgency/controller?action=hotelForm">
                <i class="fa fa-plus"></i>
					Add hotel
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/TourAgency/controller?action=transportForm">
                <i class="fa fa-plus"></i>
					Add transport
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/TourAgency/controller?action=routeForm">
                <i class="fa fa-plus"></i>
					Add route
                </a>
              </li>
