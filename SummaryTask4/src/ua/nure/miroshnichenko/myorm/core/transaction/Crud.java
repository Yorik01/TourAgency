...
interface Crud {
	 ...
	 * @throws TransactionException
	 */
	<T extends Entity> T findByPK(Class<? extends T> type, Object... values) throws TransactionException;
	 ...
	 * @throws TransactionException
	 */
	<T extends Entity> List<T> find(Class<? extends T> type, Map<String, Object> condition) throws TransactionException;
	 ...
	 * @throws TransactionException
	 */
	<T extends Entity> List<T> findAll(Class<? extends T> type) throws TransactionException;
