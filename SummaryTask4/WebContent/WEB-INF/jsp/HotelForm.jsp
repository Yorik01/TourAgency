...
<%@ page import="ua.nure.miroshnichenko.summarytask4.db.entity.HotelType"%>
<%@ page import="ua.nure.miroshnichenko.summarytask4.db.entity.Food"%>
<%@ page import="ua.nure.miroshnichenko.summarytask4.db.entity.Beach"%>
