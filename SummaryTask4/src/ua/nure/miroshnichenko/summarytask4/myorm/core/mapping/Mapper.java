...
import ua.nure.miroshnichenko.summarytask4.myorm.core.mapping.exception.MappingException;
import ua.nure.miroshnichenko.summarytask4.myorm.core.mapping.exception.MappingReflectiveException;
import ua.nure.miroshnichenko.summarytask4.myorm.core.mapping.exception.NotEntityException;

/**
 * The utility is abstraction level does converting between JDBC and classes
 * which implement {@link #ua.nure.miroshnichenko.summarytask4.myorm.Entity}. It has methods which convert
...
public final class Mapper {
	 ...
	 * {@link #ua.nure.miroshnichenko.summarytask4.myorm.Entity} of operation. It cannot be used for INSERT and
	 * UPDATE operations.
	 * 
	 * @param entity    class which implements {@link #ua.nure.miroshnichenko.summarytask4.myorm.Entity}
	 * @param operation type of sql operation
	 * @param condition condition for the query is represented by {@ #java.util.Map}
	 *                  where keys are names of columns in the database.
	 * @return string representation of sql query.
	...
	/**
	 * Return the string of sql query by the class which implements
	 * {@link #ua.nure.miroshnichenko.summarytask4.myorm.Entity} of operation and condition. It cannot be used for
	...
	/**
	 * Check if class has annotation {@link ua.nure.miroshnichenko.summarytask4.myorm.annotation.Table}
	 */
	...
	/**
	 * Return INSERT query by class which implement {@link #ua.nure.miroshnichenko.summarytask4.myorm.Entity}.
	 */
	...
	/**
	 * Return UPDATE query by class which implement {@link #ua.nure.miroshnichenko.summarytask4.myorm.Entity}.
	 */
	private static String getUpdateQuery(Entity entity) throws MappingReflectiveException {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			if (column != null) {
				PrimaryKey primaryKey = fields[i].getAnnotation(PrimaryKey.class);
				if (primaryKey == null || (primaryKey != null && !primaryKey.autoGenerated())) {
					try {
						PropertyDescriptor propertyDescriptor = new PropertyDescriptor(fields[i].getName(), type);
						Object value = propertyDescriptor.getReadMethod().invoke(entity);
